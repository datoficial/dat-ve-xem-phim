		...
		<div class="owl-one owl-carousel owl-theme">
			@php
				...
				foreach($theloaiphim as $value) {
					$allMovies = $allMovies->merge($value->Phim);
				}
				$randomMovies = $allMovies->random(4);
				$index = 1;
			@endphp

			@foreach($randomMovies as $p)
				@php 
				...
				<div class="item">
					<div class="slider-info banner-view bg bg2" style="background-image: url('{{ $banner_url }}');">
						<div class="banner-info">
							...
							<p><span class="over-para">{{ substr(strip_tags($p->mota), 0, 200) }}{{ strlen(strip_tags($p->mota)) > 100 ? '...' : '' }}</span></p>
