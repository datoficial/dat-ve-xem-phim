...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('nhanvien.baiviet.sua', ['id' => $baiviet->id]) }}" method="post">
            @csrf
                <div class="mb-3">
                    <label class="form-label" for="chude_id">Chủ đề</label>
                    <select class="form-select @error('chude_id') is-invalid @enderror" id="chude_id" name="chude_id" required><option value="">-- Chọn --</option>
