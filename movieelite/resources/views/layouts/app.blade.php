                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.theloaiphim') }}"><i class="bi bi-tags"></i> Thể loại phim</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.phim') }}"><i class="bi bi-film"></i> Phim</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.rapchieu') }}"><i class="bi bi-house-door"></i> Rạp chiếu</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.phongchieu') }}"><i class="bi bi-display"></i> Phòng chiếu</a>
                            </li>
                            <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('admin.nguoidung') }}"><i class="bi bi-person"></i> Người dùng</a>
                        </li>
                    </ul>
