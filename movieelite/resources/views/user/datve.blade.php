          ...
          <form id="form">
            ...
            @foreach($phim as $value)
              <div id="screen-select-div">
                <h2>Chọn ngày chiếu cho phim {{ $value->tenphim }}</h2>
                @foreach($value->SuatChieu as $sc)
                <div class="carousel carousel-nav" data-flickity='{"contain": true, "pageDots": false }'>
                  <div class="carousel-cell" id="1" onclick="myFunction(1)">
                    <div class="date-numeric">{{ $sc->ngaychieu }}</div>
            ...
            <fieldset>
              ...
              <div>
                <iframe id="seat-sel-iframe"
                  ...
                  src="{{ asset('public/seat_selection/seat_sel.html')}}"></iframe>
              </div>
              <br>
...
<script type="text/javascript" src="{{ asset('public/js/ticket-booking.js') }}"></script>
