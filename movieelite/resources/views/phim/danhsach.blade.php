...
@section('content')
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <p><a href="{{ route('phim.them') }}" class="btn btn-info"><i class="bi bi-plus"></i> Thêm mới</a></p>
            ...
            @foreach($phim as $value)
                <tr>
                    ...
                    <a href="{{ route('phim.sua', ['id' => $value->id]) }}"><i class="bi bi-pencil-square"></i>
                    </a>
                    </td>
                    <td class="text-center">
                    <a href="{{ route('phim.xoa', ['id' => $value->id]) }}" onclick="return confirm('Bạn có muốn xóa Thể loại phim {{ $value->tenphim }} không?')">
