					...
					<div class="card h-100">
						<div class="card-body text-center">
							...
							<ul class="list-unstyled fs-sm mb-0">
								<li>
									<span class="text-muted me-1">Bán hàng:</span>
									<a class="nav-link-style" href="mailto:customer@larashop.vn">movieelite@gmail.com</a>
								</li>
								<li class="mb-0">
									<span class="text-muted me-1">Hỗ trợ kỹ thuật:</span>
...
@endsection
@section('styles')
    <link rel="stylesheet" media="screen" href="{{ asset('public/theme.css') }}" />
@endsection