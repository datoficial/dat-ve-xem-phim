...
@section('content')
            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
                        ...
                        <li style="margin-left:10px" aria-current="page">{{ $title }}</li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="container pb-5 mb-2 mb-md-4">
        <div class="pt-3 mt-md-3">
                ...
                @foreach($baiviet as $value)
                    ...
                    <div class="card-footer d-flex align-items-center fs-xs">
                        <a class="blog-entry-meta-link" href="#user">
                            <div class="blog-entry-author-ava"><img style="width:30px;height:30px"src="{{ asset('public/assets/images/avatar.jpg') }}" /></div>{{ $value->User->name }}
                        </a>
                    <div class="ms-auto text-nowrap">
                        ...
                        <a class="blog-entry-meta-link text-nowrap" href="#view"><i class="bi bi-eye"></i>{{ $value->luotxem }}</a>
                    </div>
                </div>
                </div>
                </article>
            ...
            <ul class="pagination">
            <li class="page-item"><a class="page-link" href="#"><i class="bi bi-arrow-left-circle"></i>Lùi lại</a></li>
            </ul>
            <ul class="pagination">
            ...
            <li class="page-item"><a class="page-link" href="#" aria-label="Next">Tiếp theo<i class="bi bi-arrow-right-circle"></i></a></li>
            </ul>
            </nav>
        </div>
    </div>
