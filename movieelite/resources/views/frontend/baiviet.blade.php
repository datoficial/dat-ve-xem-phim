...
<div class="container pb-5 mb-2 mb-md-4"><div class="pt-3 mt-md-3">
...
<div class="blog-entry-author-ava"><img style="width:30px;height:30px"src="{{ asset('public/img/avatar1.jpg') }}" /></div>{{ $value->User->name }}
</a>
