...
@section('content')
    <div class="card">
        ...
        <div class="card-body table-responsive">
            <p><a href="{{ route('admin.chude.them') }}" class="btn btn-info"><i class="bi bi-plus"></i> Thêm mới</a></p>
            ...
            @foreach($chude as $value)
                <tr>
                    ...
                    <a href="{{ route('admin.chude.sua', ['id' => $value->id]) }}"><i class="fa-light fa-edit"></i>
                    </a>
                    </td>
                    <td class="text-center">
